        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <motion.div variants={slideUp} className="mb-12">
              ...
              >
                 <br />We're here to listen, collaborate, and create something <span className="text-blue-300 font-studio-pro-bold">extraordinary</span> together.
              </motion.p>
            ...
            >
              {[
                { number: '500+', label: 'Projects Completed',   color: 'from-blue-400 to-blue-600' },
                { number: '24/7', label: 'Support Available',  color: 'from-green-400 to-green-600' },
                { number: '100+', label: 'Happy Clients',  color: 'from-purple-400 to-purple-600' }
              ].map((stat, index) => (
                <motion.div
                  key={stat.label}
